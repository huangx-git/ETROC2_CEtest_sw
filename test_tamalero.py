...
if __name__ == '__main__':
    ...
    argParser.add_argument('--configuration', action='store', default='default', choices=['default', 'emulator', 'modulev0', 'modulev0b', 'multimodule', 'modulev1'], help="Specify a configuration of the RB, e.g. emulator or modulev0")
